...
#define BDAUTHORIZE_HOSTURL                 @"http://openapi.baidu.com/oauth/2.0/authorize"
//#define BDAUTHORIZE_REDIRECTURI             @"http://openapi.baidu.com/oauth/2.0/login_redirect"
#define BDAUTHORIZE_REDIRECTURI             @"bdconnect://success"
#define BDAUTHORIZE_TOKEN                   @"http://openapi.baidu.com/oauth/2.0/token"
